  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-4 sm:py-24">
        <p className="text-sm font-semibold uppercase tracking-[0.14em] text-hh-primary">
          Heart &amp; Hustle Fundraising
        </p>
        <h1 className="mt-3 text-balance text-3xl font-bold tracking-tight text-hh-dark sm:text-5xl">
          Built by Heart. Powered by Hustle.
        </h1>
        <p className="mt-4 max-w-3xl text-balance text-lg font-semibold leading-relaxed text-slate-800 sm:text-2xl">
          The #1 fundraising platform for high school athletics, activities, and
          booster clubs.
        </p>
        <p className="mt-3 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg">
          Built for teams, clubs, and activities—and ready for youth nonprofits
          and other community programs that want the same simple, private
          fundraising.
        </p>
        ...
        >
          <span className="inline-flex items-center rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold tracking-wide text-slate-700 shadow-sm">
            FERPA compliant
          </span>
          <span className="inline-flex items-center rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold tracking-wide text-slate-700 shadow-sm">
            COPPA compliant
        ...
        <ul className="mt-10 max-w-2xl space-y-3 text-base text-slate-700 sm:text-lg">
        ...
        <section className="mt-12 max-w-3xl rounded-2xl border border-slate-200/90 bg-white p-6 shadow-sm sm:p-8">
          ...
          <ul className="mt-6 grid gap-5 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-6">
            <li>
              <p className="font-semibold text-hh-dark">
            ...
            <li>
              ...
              <p className="mt-1 text-sm leading-snug text-slate-600">
                ...
                participant data. Supporters give to the team—not to a marketplace
                built on reselling leads.
              </p>
            </li>
            <li>
