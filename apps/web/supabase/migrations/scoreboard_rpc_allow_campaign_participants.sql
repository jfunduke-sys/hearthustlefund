-- Allow any participant (athlete row on this fundraiser) to call
-- fundraiser_groups_scoreboard so the mobile Teams tab shows group totals for
-- everyone, not only coaches and group managers.
